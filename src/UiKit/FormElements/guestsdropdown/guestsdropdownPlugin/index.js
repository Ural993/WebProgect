...
(function ($) {
  const defaults = {
    ...
    controls: {
      position: 'right',
      displayCls: 'guestsdropdown-content',
      controlsCls: 'guestsdropdown-item-controls',
      counterCls: 'counter',
    },
    items: {},
    onChange: () => {},
    ...
    setSelectionText (txt, totalItems) {
      ...
      if(totalItems === 0){
        $('.guestsdropdown-button-clear').css('opacity', '0');
        $('.guestsdropdown-button-clear').css('cursor', 'auto');
        ...
        $('.guestsdropdown-button-clear').css('opacity', '1'); 
        $('.guestsdropdown-button-clear').css('cursor', 'pointer');  
      cases = [2, 0, 1, 1, 1, 2];  
      return `${totalItems} ${this.txt[ (totalItems%100>4 && totalItems%100<20)? 2 : 
  ...
  $.fn.guestsDropdownPlugin = function (options) {
    this.each(function () {
      const $this = $(this);
      const $selection = $this.find('p.guestsdropdown-selection').last();
      const $menu = $this.find('div.guestsdropdown-menu');
      const $items = $menu.find('div.guestsdropdown-menu-option');
      ...
      const itemCount = {};
      let totalItems = 0;
      const $clearButton = $('.guestsdropdown-button-clear');
      const $applyButton = $('.guestsdropdown-button-apply');
      ...
      function addControls (id, $item) {
        ...
        const $buttonsWrapper = $('.guestsdropdown-buttons');
